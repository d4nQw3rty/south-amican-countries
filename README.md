...
**[South America's countries] The user can check South Americans Countries information.
...
- [Live Demo Link](https://southamerica-countries.netlify.app/)
...
```sh
  git clone git@github.com:d4nQw3rty/capstone3.git
```
...
Feel free to check the [issues page](https://github.com/d4nQw3rty/capstone3/issues).
...
- Thanks to Nelson Sakwa for his Design [visit site](https://www.behance.net/gallery/31579789/Ballhead-App-(Free-PSDs)).
